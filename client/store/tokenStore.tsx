...
interface TokenStore {
  ...
  fetchTrendingTokens: (limit?: number, isBackgroundRefresh?: boolean) => Promise<void>;

  userTokens: Token[];
  isLoadingUserTokens: boolean;
  fetchUserTokens: (userAddress: string, isBackgroundRefresh?: boolean) => Promise<void>;

  currentToken: Token | null;
  isLoadingCurrentToken: boolean;
  fetchTokenDetails: (mintAddress: string, isBackgroundRefresh?: boolean) => Promise<void>;
}
...
export const useTokenStore = create<TokenStore>((set, get) => ({
  ...
  fetchTokenDetails: async (mintAddress: string, isBackgroundRefresh = false) => {
    try {
      if (!isBackgroundRefresh) {
